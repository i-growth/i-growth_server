...
import { DevMakeAsDone, GetChildByGuardianNIC, GetChildByID, GetChildVaccineDetails, GetDevActivity, ParentCheckAuth, ParentLogin, ParentLogout } from '../methods/ParentMethod.js';
...
router.get('/check-auth', ParentCheckAuth);
